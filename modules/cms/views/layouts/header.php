...
<div class="navbar navbar-expand-md navbar-light navbar-static">
    ...
    <div class="collapse navbar-collapse" id="navbar-mobile">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a href="<?= CMSConfig::getUrl('point-clound') ?>" class="navbar-nav-link">
            ...
            <?php else : ?>
                <li class="nav-item dropdown dropdown-user">
                    ...
                    <div class="dropdown-menu dropdown-menu-right" style="z-index: 102">
                        <a href="<?= APPConfig::getUrl('user/point') ?>" class="dropdown-item"><i class="icon-image2"></i> Point của tôi</a>
                        <div class="dropdown-divider my-0"></div>
                        <a href="<?= APPConfig::getUrl('user/profile') ?>" class="dropdown-item"><i class="icon-user-plus"></i> Trang cá nhân</a>
                        <div class="dropdown-divider my-0"></div>
