...
$pageData = [
    ...
    'pageBreadcrumb' => [['Lịch trình của tôi']],
            ...
            <div class="container">
                ...
                <div class="loaded-data" v-else>
                    ...
                    <div class="available-data" v-else>
                        <div class="row">
                            <my-plan v-for="plan in plans" :plan="plan" :col="3" :key="plan.id" @confirm-delete="confirmDelete"></my-plan>
                        </div>
                    </div>
                </div>
            </div>
    ...
    $(function() {
        ...
        var vm = new Vue({
            ...
            methods: {
                getMyPlans: function() {
                    var _this = this
                    var api = '<?= APPConfig::getUrl('user/get-user-plans') ?>'
