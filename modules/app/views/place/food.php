...
<div class="content container mt-3" id="food-page">
    <div class="row">
                    ...
                    <div class="form-search" v-cloak>
                        <div class="form-group">
                            <div class="input-group">
                                <input type="text" class="form-control border-right-0" placeholder="Tên địa điểm ăn uống" v-model="keyword">
                        ...
                        <div class="media flex-column flex-sm-row mt-0 mb-3" v-cloak>
                            <ul class="media-list media-list-linked media-list-bordered w-100">
                                <li v-for="item in foods">
                                    <div class="media">
                                        <div class="mr-2">
                                            <a :href="'<?= APPConfig::getUrl('food/') ?>' + item.slug" class="media-list-photo">
                                                <img :src="'<?= Yii::$app->homeUrl . 'uploads/' ?>' + item.thumbnail" height="150" width="225" :alt="item.name">
                                            </a>
                                        </div>
                                        <div class="media-body">
                                            <h5 class="media-title font-weight-bold"><a :href="'<?= APPConfig::getUrl('food/') ?>' + item.slug">{{ item.name }}</a></h5>
                                            {{ item.subtitle }}
