        ...
        <div class="col-md-4 sidebar-wrap">
                ...
                <div class="card-body">
                    <div class="form-search" v-cloak>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control" v-model="order" @change="getFoods()">
            ...
            <div class="card">
                <div class="card-body d-flex justify-content-center">
                    <a href="<?= APPConfig::getUrl('place/food-map') ?>" class="btn bg-pink-400 rounded-round">
            ...
            methods: {
                getFoods: function() {
                    ...
                    var api = '<?= APPConfig::getUrl('place/get-place-list') ?>' +
                        `?page=${this.page}&perpage=${this.perpage}&destination=${this.destination}&keyword=${this.keyword}&order=${this.order}&type=` + '<?= PlaceService::$TYPE['FOOD'] ?>'
