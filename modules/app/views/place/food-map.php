...
?>
<div id="food-map-page" class="map-page">
            ...
            <div class="position-relative h-100">
                <div class="sidebar-content h-100 overflow-auto">
                    <div class="sidebar-header p-3">
                        <h4 class="mb-0 font-weight-bold"><a href="<?= APPConfig::getUrl('place/food') ?>"><i class="icon-circle-left2 mr-2"></i></a>Bản đồ địa điểm ăn uống</h4>
                    </div>
                    <hr class="my-1">
